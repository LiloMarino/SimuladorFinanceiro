...
**Lista ordenada por retorno:**
- Mostra todos os jogadores na sessão
- Ordenados do maior para o menor retorno
- Seu usuário fica destacado

**Para cada jogador, mostra:**
- **Posição**
- **Jogador**
- **Patrimônio** - Valor total da carteira
...
**Gráfico de linhas comparativo** com a evolução de todos os jogadores. Você pode alternar entre:
...
Cada jogador aparece com uma linha própria e o gráfico mostra a evolução ao longo do tempo.

---

### Resumo da Partida

Um card com um resumo rápido da rodada atual:
